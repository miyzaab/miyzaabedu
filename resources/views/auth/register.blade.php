<x-guest-layout>
    <div class="mb-8">
        ...
        <p class="text-gray-500 text-sm">Bergabunglah bersama komunitas kami</p>
    </div>
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-5">
        ...
        <div class="relative">
            ...
            <x-text-input id="email"
                class="block w-full pl-10 py-3 bg-gray-50 border-gray-200 text-gray-900 placeholder-gray-400 focus:bg-white focus:border-emerald-500 focus:ring-emerald-500 rounded-xl transition"
                type="email" name="email" :value="old('email')" required placeholder="Alamat Email"
        ...
        <div class="relative">
            ...
            <x-text-input id="password"
                class="block w-full pl-10 py-3 bg-gray-50 border-gray-200 text-gray-900 placeholder-gray-400 focus:bg-white focus:border-emerald-500 focus:ring-emerald-500 rounded-xl transition"
                type="password" name="password" required placeholder="Kata Sandi" autocomplete="new-password" />
        ...
        <div class="relative">
            ...
            <x-text-input id="password_confirmation"
                class="block w-full pl-10 py-3 bg-gray-50 border-gray-200 text-gray-900 placeholder-gray-400 focus:bg-white focus:border-emerald-500 focus:ring-emerald-500 rounded-xl transition"
                type="password" name="password_confirmation" required placeholder="Konfirmasi Kata Sandi"
        ...
        <div class="relative py-2">
            ...
            <div class="relative flex justify-center text-sm">
                <span class="px-2 bg-white text-gray-400">Atau daftar dengan</span>
            </div>
        </div>
        ...
        <div class="text-center mt-6">
            ...
            <a class="text-sm font-semibold text-emerald-600 hover:text-emerald-500 ml-1" href="{{ route('login') }}">
                Masuk disini
            </a>
        </div>
    </form>
