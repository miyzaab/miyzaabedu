<x-admin-layout>
    <div class="mb-8">
        ...
        <h1 class="text-3xl font-bold text-gray-800 mt-2">Tambah Video Baru</h1>
    </div>
        ...
        <form action="{{ route('admin.videos.store') }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <input type="text" name="title" value="{{ old('title') }}" required
                    ...
                    placeholder="Contoh: Kajian Fiqih Shalat">
            ...
            <div class="mb-6">
                ...
                <textarea name="description" rows="3"
                    class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500">{{ old('description') }}</textarea>
            </div>
